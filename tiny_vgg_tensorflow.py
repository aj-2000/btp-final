...
tiny_class_dict = load(open('class_dict.json', 'r'))
tiny_val_class_dict = load(open('file_dict.json', 'r'))

training_images = './full/*/*.jpeg'
vali_images = './train/*.jpeg'
...
tiny_vgg.save('starting_tiny_vgg.h5')
